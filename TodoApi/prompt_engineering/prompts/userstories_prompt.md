```md
Actúa como analista funcional. A partir del código del controlador de tareas, genera al menos 5 historias de usuario completas en formato estándar (como usuario..., quiero..., para...).
