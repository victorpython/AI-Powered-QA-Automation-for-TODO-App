# AI-Powered-QA-Automation-for-TODO-App
 Automated end-to-end quality assurance for a TODO application using Selenium and AI-driven prompt engineering to generate user stories, test cases and documentation.
 # AI-Powered QA Automation for TODO App
